...
`	  `5. Результат подсчёта отображается в профиле пользователя в разделе "Управление профилем" -> "Основные данные".
...
`	  `3. Результат подсчёта отображается в профиле пользователя в разделе "Управление профилем" -> "Основные данные"-> "Экологический вклад".
...
`	  `5. Результат подсчёта сэкономленной воды отображается в счётчике воды.
...
`	  `5. Результат подсчёта сэкономленного выброса углекислого газа отображается в счётчике выброса углексилого газа.
